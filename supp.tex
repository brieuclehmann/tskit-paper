...
relatedness matrices (GRMs) and GRM-vector products directly from an ARG.
As described in \citet{lehmann2026on},
for one million diploids on human chromosome~21, the 
...
and compare the GRM-vector prodcut to the corresponding approximate (Monte Carlo)
implementation in ARGneedle-lib~\citep{zhang2023biobank}, shwing that tskit is
