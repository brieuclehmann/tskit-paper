...
close to C speed. Building on this, \citet{tagami2024tstrait}
introduced edge-wise effect-size dropping as a primitive for
quantitative-trait simulation on ARGs, and
\citet{karthikeyan2025tsbrowse} introduced on-the-fly
quality-control and summary operations for interactive inspection
of large tree sequences. \citet{fritze2026forest} introduced a
class of haplotype-level queries that operate directly on the edge
table rather than tree by tree, and \citet{lehmann2026on}
